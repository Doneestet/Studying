...
function slider() {
  ...
  dotsWrap.addEventListener('click', function (event) {
    // так как мы используем делегирование событий добавляем event
...
function timer() {
  ...
  function getTimeRemaining(endtime) {
    ...
    var t = Date.parse(endtime) - Date.parse(new Date()),
        ...
        hours = Math.floor(t / (1000 * 60 * 60)); // возвращает целый объект с данными
  ...
  function setClock(id, endtime) {
    ...
    function updateClock() {
      var t = getTimeRemaining(endtime); // сначала получает разницу между временем
